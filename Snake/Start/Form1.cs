    ...
    public partial class Form1 : Form
    {
        ...
        private void Update(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Insert.KeyPressed(Keys.Right) && GamePlay.direction != Direction.Left)
                    GamePlay.direction = Direction.Right;
                else if (Insert.KeyPressed(Keys.Left) && GamePlay.direction != Direction.Right)
                    GamePlay.direction = Direction.Left;
                else if (Insert.KeyPressed(Keys.Up) && GamePlay.direction != Direction.Down)
                    GamePlay.direction = Direction.Up;
                else if (Insert.KeyPressed(Keys.Down) && GamePlay.direction != Direction.Up)
